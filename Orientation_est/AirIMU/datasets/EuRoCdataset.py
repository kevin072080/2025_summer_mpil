...
class Euroc(Sequence):
    ...
    def __init__(self, data_root, data_name, intepolate = True, calib = False, load_vicon = False, glob_coord=False, **kwargs):
        ...
        self.vicon_ext_R =  pp.mat2SO3(np.array([[0.33638, -0.01749,  0.94156],
                                                 [-0.02078, -0.99972, -0.01114],
                                                 [0.94150, -0.01582, -0.33665]]), check= False)
        ...
        if intepolate:
            ...
            for k in ['gt_time', 'pos', 'quat', 'velocity', 'b_acc', 'b_gyro']: # dataset 불러오는 단계에서 이미 interpolated, idx 정렬까지
