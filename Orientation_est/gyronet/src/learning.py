...
class GyroLearningBasedProcessing(LearningBasedProcessing):
    ...
    def display_test(self, dataset, mode):
        ...
        for i, seq in enumerate(dataset.sequences):
            ...
            plt.show()
        file_path_ori = os.path.join(self.address, "orientation_Gyronet.json")
        file_path_metric = os.path.join(self.address, "metric_Gyronet.json")
    ...
    def plot_gyro(self, seq):
        ...
        resultdict_ori = {
            ...
            'qx': SO3.to_quaternion(net_Rots, ordering='xyzw')[:, 0].tolist(), # wxyz
