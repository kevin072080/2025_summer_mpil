...
data_dir = '/home/mpil/miniconda3/envs/gyronet/TUMVI_dataset'
...
# in_dim, out_dim, channelC, kernalC, diaC, dropout, momentum, fc_num, diaS, diaT
net_params = {
    'in_dim': 6,
    'out_dim': 3,
    'dims' : [16, 32, 64, 128],
...
dataset_params = {
    ...
    'N': 9984, # should be integer * 'max_train_freq'
    'min_train_freq': 16,
    'max_train_freq': 32,
}
################################################################################
