...
data_dir = '/home/mpil/PycharmProjects/RoNIN/Data/local_frame/train_merge_localframe'
predata_dir = '/home/mpil/PycharmProjects/RoNIN/Data/cache_localframe' # p 파일 저장 경로
train_list_txt = '/home/mpil/PycharmProjects/RoNIN/ronin-master/lists/list_train2.txt'
#test_list_txt = '/home/mpil/PycharmProjects/RoNIN/ronin-master/lists/list_test_seen.txt'
test_list_txt = '/home/mpil/PycharmProjects/RoNIN/ronin-master/lists/list_test_for_imu.txt'
val_list_txt = '/home/mpil/PycharmProjects/RoNIN/ronin-master/lists/list_val.txt'
...
#dataset_params['train_seqs'] = load_str_list(val_list_txt)
dataset_params['train_seqs'] = load_str_list(train_list_txt)
#dataset_params['train_seqs'] = load_str_list(test_list_txt)
...
train_params = {
    ...
    'loss': {
        ...
        'w':  1e6,
        'target': 'rotation matrix', #target': 'rotation matrix
        'huber': 0.005,
        'dt': 0.005,
    },
    ...
    'res_dir': os.path.join(base_dir, "results/Ronin"),
    # where record Tensorboard log ?
    'tb_dir': os.path.join(base_dir, "results/runs/Ronin"),
}
################################################################################
