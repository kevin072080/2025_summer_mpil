...
class SeqDataset(Data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        return {
            'timestamp': self.data['time'][frame_id: end_frame_id],
            'dt': self.data['dt'][frame_id: end_frame_id].T,
            'acc': self.data['acc'][frame_id: end_frame_id].T,
            'gyro': self.data['gyro'][frame_id: end_frame_id].T,
            'rot': self.data['gt_orientation'][frame_id: end_frame_id].T,
            'gt_pos': self.data['gt_translation'][frame_id+1: end_frame_id+1].T,
            'gt_rot': self.data['gt_orientation'][frame_id+1: end_frame_id+1].T,
            'gt_vel': self.data['velocity'][frame_id+1: end_frame_id+1].T,
            'init_pos': self.data['gt_translation'][frame_id][None, ...].T,
            'init_rot': self.data['gt_orientation'][frame_id: end_frame_id].T,
            'init_vel': self.data['velocity'][frame_id][None, ...].T,
        }

    def get_init_value(self): #eval error -> .T
        return {'pos': self.data['gt_translation'][:1].T,
                'rot': self.data['gt_orientation'][:1].T,
                'vel': self.data['velocity'][:1].T}
...
class SeqeuncesDataset(Data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        data = {
            'dt': self.dt[seq_id][frame_id: end_frame_id].T,
            'acc': self.acc[seq_id][frame_id: end_frame_id].T,
            'gyro': self.gyro[seq_id][frame_id: end_frame_id].T,
            'rot': self.gt_ori[seq_id][frame_id: end_frame_id].T
        }
        init_state = {
        ...
        label = {
            'gt_pos': self.gt_pos[seq_id][frame_id+1 : end_frame_id+1].T,
            'gt_rot': self.gt_ori[seq_id][frame_id+1 : end_frame_id+1].T,
            'gt_vel': self.gt_velo[seq_id][frame_id+1 : end_frame_id+1].T,
        }
        time = {
            'timestamp': self.ts[seq_id][frame_id: end_frame_id + 1],
        }

        return {**data, **init_state, **label, **time}
