...
if __name__ == '__main__':
    ...
    """
    default_config_file = osp.abspath(osp.join(osp.abspath(__file__), '/home/mpil/PycharmProjects/RoNIN/config/heading_model_defaults.json'))
