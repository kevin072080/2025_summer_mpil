...
class GlobSpeedSequence(CompiledSequence):
    ...
    def load(self, data_path):
        ...
        with h5py.File(osp.join(data_path, 'data.hdf5')) as f:
            ...
            acce_uncalib = f['synced/linacce'] # acce - grav -> bias가 두 번 영향을 준다고 생각함
        ...
        rot_imu_to_tango = quaternion.quaternion(*self.info['start_calibration']) # global frame compensation (spatial alignment)
        ...
        glob_v = (tango_pos[self.w:] - tango_pos[:-self.w]) / dt # g vector subtracted impact X
