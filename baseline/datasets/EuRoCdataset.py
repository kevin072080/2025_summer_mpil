...
from utils import lookAt, qinterp, Gaussian_noise, CPU_Unpickler
...
class CorrectedEuroc(Sequence):
    def __init__(
        ...
        **kwargs
        ...
        super(CorrectedEuroc, self).__init__()
        (
            self.data_root,
            self.data_name,
            self.data,
        ...
        data_path = os.path.join(data_root, data_name)
        pickle_path = kwargs.data_list.pickle_path
        net_result_path = os.path.join(pickle_path, 'net_output.pickle')
        ...
        self.load_imu(data_path, pickle_path)
        self.load_gt(data_path)
        ...
        def load_imu(data_path, pickle_path):
            dd
        def load_gt(data_path, pickle_path):
            dd
